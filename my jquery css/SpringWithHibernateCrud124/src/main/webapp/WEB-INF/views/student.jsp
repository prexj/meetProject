...
<title>Insert title here</title>
	...
	jQuery(document).ready(function() {
		...
		var id = $("#id").val();
		if(id == '' ){
			title = "Add Release And Receipt Data";
		}else{
			title = "Edit Release And Receipt Data";
		}
...
<body>
	...
	<input id="showPage" type="hidden" name="showPage"  value="2"/>
	...
	<table class="GridOne">
	  <thead>
		  ...
		  <th> Sponsor </th>
		  <th> Investigator </th>
		  <th> Investigator Medical Product </th>
	...
	<div id="confirmationDialog">
        <table class="GridOne">
	        <tr>
			 ...
			 <tr>
				<td>
					<label>Investigator Medical Product</label>
				</td> 
				<td>
